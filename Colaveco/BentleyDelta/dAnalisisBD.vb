...
#Region "Métodos ABM"
    ...
    Public Function vaciar(ByVal usuario As dUsuario) As Boolean
        Dim p As New pAnalisisBD
        Return p.vaciar(Me, usuario)
    End Function
    Public Function buscar() As dAnalisisBD
        Dim p As New pAnalisisBD
        Return p.buscar(Me)
    End Function
    Public Function buscarxarchivo() As dAnalisisBD
        Dim p As New pAnalisisBD
