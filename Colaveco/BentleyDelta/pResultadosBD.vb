Public Class pResultadosBD
    Inherits Conectoras.ConexionMySQL_BentleyDelta
    Public Function guardar(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        Dim obj As dResultadosBD = CType(o, dResultadosBD)
    ...
    Public Function eliminar(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        ...
        Return EjecutarTransaccion(lista)
    End Function
    Public Function buscar(ByVal o As Object) As dResultadosBD
        Dim obj As dResultadosBD = CType(o, dResultadosBD)
        Dim l As New dResultadosBD
        Try
