...
#Region "Métodos ABM"
    ...
    Public Function vaciar(ByVal usuario As dUsuario, ByVal arch As String) As Boolean
        Dim p As New pAnalisisBD_
        Return p.vaciar(Me, usuario, arch)
    End Function
    Public Function buscar() As dAnalisisBD_
        Dim p As New pAnalisisBD_
        Return p.buscar(Me)
    End Function
    Public Function buscarxarchivo() As dAnalisisBD_
        Dim p As New pAnalisisBD_
