...
#Region "Constructores"
    ...
    End Sub
    Public Sub New(ByVal id As Long, ByVal fecha As String, ByVal hora As String, ByVal equipo As String, ByVal ficha As Long, ByVal cantidad As Integer, ByVal idtipoinforme As Integer, ByVal operador As Integer, ByVal observaciones As String)
        m_id = id
        m_fecha = fecha
        m_hora = hora
        m_equipo = equipo
...
#Region "Métodos ABM"
    ...
    End Function
    Public Function buscar() As dRgLab101
        Dim c As New pRgLab101
        Return c.buscar(Me)
    End Function
