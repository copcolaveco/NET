Public Class dControldeInformes
#Region "Atributos"
...
#Region "Constructores"
    Public Sub New()
        ...
        m_controlado = 0
    End Sub
    Public Sub New(ByVal id As Long, ByVal fechacontrol As String, ByVal ficha As Long, ByVal fecha As String, ByVal muestra As Integer, ByVal tipo As Integer, ByVal subtipo As Integer, ByVal resultado As Integer, ByVal coincide As Integer, ByVal om As Integer, ByVal nc As Integer, ByVal observaciones As String, ByVal controlador As Integer, ByVal controlado As Integer)
        m_id = id
...
#Region "Métodos ABM"
    ...
    End Function
    Public Function buscar() As dControldeInformes
        Dim c As New pControldeInformes
        Return c.buscar(Me)
    End Function
