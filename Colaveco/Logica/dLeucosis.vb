...
#Region "Métodos ABM"
    ...
    End Function
    Public Function buscar() As dLeucosis
        Dim c As New pLeucosis
        Return c.buscar(Me)
    End Function
    Public Function buscarxfichaxmuestra() As dLeucosis
        Dim c As New pLeucosis
        Return c.buscarxfichaxmuestra(Me)
    End Function
    Public Function buscarxficha() As dLeucosis
        Dim c As New pLeucosis
...
#End Region
    ...
    End Function
    Public Function marcar(ByVal idgrupal As Long, ByVal usuario As dUsuario) As Boolean
        Dim c As New pLeucosis
        Return c.marcar(idgrupal, usuario)
    End Function
End Class
