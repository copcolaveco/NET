...
#Region "Constructores"
    Public Sub New()
        ...
        m_pordefecto = 0
    End Sub
    Public Sub New(ByVal id As Integer, ByVal analisis As Integer, ByVal metodo As String, ByVal pordefecto As Integer)
        m_id = id
        m_analisis = analisis
        m_metodo = metodo
...
#Region "Métodos ABM"
    ...
    End Function
    Public Function buscar() As dListaMetodos
        Dim p As New pListaMetodos
        Return p.buscar(Me)
    End Function
    Public Function buscarxanalisis() As dListaMetodos
        Dim p As New pListaMetodos
        Return p.buscarxanalisis(Me)
    End Function
    Public Function buscarxanalisisymetodo() As dListaMetodos
        Dim p As New pListaMetodos
        Return p.buscarxanalisisymetodo(Me)
    End Function
#End Region

    Public Overrides Function ToString() As String
        Return m_metodo & " - " & m_pordefecto
    End Function
