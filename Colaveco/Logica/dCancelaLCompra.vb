...
#Region "Constructores"
    Public Sub New()
        ...
        m_visto = 0
    End Sub
    Public Sub New(ByVal id As Integer, ByVal idcompra As Long, ByVal fecha As String, ByVal proveedor As Integer, ByVal producto As Integer, ByVal usuariocreador As Integer, ByVal usuariocancela As Integer, ByVal visto As Integer)
        m_id = id
        m_idcompra = idcompra
        m_fecha = fecha
...
#Region "Métodos ABM"
    ...
    End Function
    Public Function buscar() As dCancelaLCompra
        Dim p As New pCancelaLCompra
        Return p.buscar(Me)
    End Function
#End Region
