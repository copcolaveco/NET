...
Imports System.IO
Public Class FormInformeSubproductos
...
#End Region
    ...
    Private Sub listarfichas()
        ...
        lista = s.listarfichassubproductos
    ...
    Private Sub ButtonGenerarInforme_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonGenerarInforme.Click
        If TextFicha.Text.Length > 0 Then
            ...
            Dim Arch1 As String = ""
            'Arch1 = "\\192.168.1.10\E\NET\PREINFORMES\ALIMENTOS\" & ficha & ".xls"
            Arch1 = "\\ROBOT\PREINFORMES\ALIMENTOS\" & ficha & ".xls"
