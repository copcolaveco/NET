Public Class FormNutricion
    ...
    Private metdon As Integer = 0
    Private metafla As Integer = 0
    Private metzeara As Integer = 0
    Private metfibraefectiva As Integer = 0
    Private metclostridios As Integer = 0
    Private metzinc As Integer = 0
    Private metcalcio As Integer = 0
    Private metfosforo As Integer = 0
...
#End Region
    ...
    Public Sub cargarComboAlimento()
        ...
        If Not clasealimento Is Nothing Then
    ...
    Private Sub limpiar()
        ...
        TextAfla.Text = ""
        TextZeara.Text = ""
        TextFibraEfectiva.Text = ""
        TextClostridios.Text = ""
        deshabilitarcontroles()
    End Sub
    Private Sub deshabilitarcontroles()
        TextMSH.Enabled = False
        TextCenizasH.Enabled = True ' se habilita a pedido de Jeny
        TextCenizasS.Enabled = True ' se habilita a pedido de Jeny
        TextPBH.Enabled = False
        TextPBS.Enabled = True ' se habilita a pedido de Jeny
        ...
        TextDon.Enabled = False
        TextAfla.Enabled = False
        TextZeara.Enabled = False
        TextFibraEfectiva.Enabled = False
        TextClostridios.Enabled = False
    End Sub
    ...
    Private Sub ListMuestras_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListMuestras.SelectedIndexChanged
        ...
        If ListMuestras.SelectedItems.Count = 1 Then
            ...
            For Each nc In ComboClase.Items
                If nc.ID = n.CLASE Then
                    ComboClase.SelectedItem = nc
                    Exit For
                End If
            Next
            ComboAlimento.SelectedItem = Nothing
            Dim na As dNutricionAlimento
            For Each na In ComboAlimento.Items
                If na.ID = n.ALIMENTO Then
                    ComboAlimento.SelectedItem = na
                    Exit For
                End If
            Next
            '********************************************
            ...
            End If
            If n.AFLA <> "-1" Then
                TextAfla.Text = n.AFLA
            End If
            If n.ZEARA <> "-1" Then
                TextZeara.Text = n.ZEARA
            End If
            If n.FIBRAEFECTIVA <> "-1" Then
                TextFibraEfectiva.Text = n.FIBRAEFECTIVA
            End If
            If n.CLOSTRIDIOS <> "-1" Then
                TextClostridios.Text = n.CLOSTRIDIOS
            End If
            If n.ZINC <> "-1" Then
                TextZinc.Text = n.ZINC
            End If
            If n.CALCIO <> "-1" Then
                TextCalcio.Text = n.CALCIO
            End If
            If n.FOSFORO <> "-1" Then
                TextFosforo.Text = n.FOSFORO
            End If
            '****************************************************************************
            ...
            If Not sn_ Is Nothing Then
                ...
                If sn_.PH = 1 Then
                    texto_ = texto_ & "pH / "
                End If
                If sn_.MICOTOXINAS = 1 Then
                    texto_ = texto_ & "Micotoxinas / "
                End If
                If sn_.PROTEINAS = 1 Then
                    texto_ = texto_ & "Proteínas / "
                End If
                If sn_.MATERIASECA = 1 Then
                    texto_ = texto_ & "Materia seca / "
                End If
                If sn_.FIBRAEFECTIVA = 1 Then
                    texto_ = texto_ & "Fibra efectiva / "
                End If
                If sn_.CLOSTRIDIOS = 1 Then
                    texto_ = texto_ & "Clostridios / "
                End If
                If sn_.FIBRANEUTRA = 1 Then
                    texto_ = texto_ & "Fibra neutra / "
                End If
                If sn_.FIBRAACIDA = 1 Then
                    texto_ = texto_ & "Fibra ácida / "
                End If
            ...
            If Not sn Is Nothing Then
                ...
                If sn.MICOTOXINAS = 1 Then
                    TextDon.Enabled = True
                    TextAfla.Enabled = True
                    TextZeara.Enabled = True
                End If
                ...
                If sn.FIBRAEFECTIVA = 1 Then
                    TextFibraEfectiva.Enabled = True
                End If
                If sn.CLOSTRIDIOS = 1 Then
                    TextClostridios.Enabled = True
                End If
                If sn.TIMAC = 1 Then
                    TextMSH.Enabled = True
                    TextCenizasH.Enabled = True
    ...
    Private Sub guardar()
        ...
        End If
        If TextObservacionesMicotoxinas.Text <> "" Then
            observaciones = observaciones & " - " & TextObservacionesMicotoxinas.Text
        End If
        Dim msh As Double = 0
        ...
        Dim afla As String = ""
        Dim zeara As String = ""
        Dim fibraefectiva As String = ""
        Dim clostridios As String = ""
        ...
        Else
            nidah = -1
        End If
        If TextDon.Text <> "" Then
            don = TextDon.Text.Trim
        Else
            don = -1
        End If
        If TextAfla.Text <> "" Then
            afla = TextAfla.Text.Trim
        Else
            afla = -1
        End If
        If TextZeara.Text <> "" Then
            zeara = TextZeara.Text.Trim
        Else
            zeara = -1
        End If
        If TextFibraEfectiva.Text <> "" Then
            fibraefectiva = TextFibraEfectiva.Text.Trim
        Else
            fibraefectiva = -1
        End If
        If TextClostridios.Text <> "" Then
            clostridios = TextClostridios.Text.Trim
        Else
            clostridios = -1
        End If
        ...
        Else
            calcio = -1
        End If
        If TextFosforo.Text <> "" Then
            fosforo = TextFosforo.Text.Trim
        Else
            fosforo = -1
        End If
        ...
        If TextId.Text.Trim.Length > 0 Then
            ...
            Else
                n.ZEARAM = 0
            End If
            n.FIBRAEFECTIVA = fibraefectiva
            If metfibraefectiva <> 0 Then
                n.FIBRAEFECTIVAM = metfibraefectiva
            Else
                n.FIBRAEFECTIVAM = 83
            End If
            n.CLOSTRIDIOS = clostridios
            If metclostridios <> 0 Then
                n.CLOSTRIDIOSM = metclostridios
            Else
                n.CLOSTRIDIOSM = 84
            End If
            n.ZINC = zinc
            ...
            End If
            n.FOSFORO = fosforo
            If metfosforo <> 0 Then
                n.FOSFOROM = metfosforo
            Else
                n.FOSFOROM = 87
            End If
            n.OPERADOR = operador
    ...
    Private Sub ButtonDon_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonDon.Click
        textometodo = "Don"
        Dim v As New FormBuscarMetodos
        v.ShowDialog()
        If Not v.Metodos Is Nothing Then
    ...
    Private Sub ButtonAfla_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonAfla.Click
        textometodo = "Afla"
        Dim v As New FormBuscarMetodos
        v.ShowDialog()
        If Not v.Metodos Is Nothing Then
    ...
    Private Sub ButtonZeara_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonZeara.Click
        textometodo = "Zeara"
        Dim v As New FormBuscarMetodos
        v.ShowDialog()
        If Not v.Metodos Is Nothing Then
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonFibra.Click
        textometodo = "Fibra efectiva"
        Dim v As New FormBuscarMetodos
        v.ShowDialog()
        If Not v.Metodos Is Nothing Then
            Dim met As dMetodos = v.Metodos
            metfibraefectiva = met.ID
        End If
    End Sub

    Private Sub ButtonClostridios_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonClostridios.Click
        textometodo = "Clostridios"
        Dim v As New FormBuscarMetodos
        v.ShowDialog()
        If Not v.Metodos Is Nothing Then
            Dim met As dMetodos = v.Metodos
            metclostridios = met.ID
        End If
    End Sub

    Private Sub ButtonZinc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonZinc.Click
        textometodo = "Zinc"
        Dim v As New FormBuscarMetodos
        v.ShowDialog()
        If Not v.Metodos Is Nothing Then
    ...
    Private Sub ButtonCalcio_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonCalcio.Click
        textometodo = "Calcio"
        Dim v As New FormBuscarMetodos
        v.ShowDialog()
        If Not v.Metodos Is Nothing Then
    ...
    Private Sub ButtonFosforo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonFosforo.Click
        textometodo = "Fósforo"
        Dim v As New FormBuscarMetodos
        v.ShowDialog()
        If Not v.Metodos Is Nothing Then
