...
#End Region
    ...
    Private Sub recorroplanilla()
        ...
        For i = 1 To CantFilas
            ...
            valor30 = Val(Trim(x1hoja.Cells(i, 8).formula))
            valor = Val(Trim(x1hoja.Cells(i, 9).formula))
            If valor90 > 100 Then 'Trim(x1hoja.Cells(i, 6).formula) > 0 Then
                debe = 1
            ElseIf valor60 > 100 Then 'Trim(x1hoja.Cells(i, 7).formula) > 0 Then
                debe = 1
            ElseIf valor30 > 100 Then 'Trim(x1hoja.Cells(i, 9).formula) > 0 Then
                debe = 1
            ElseIf valor > 100 Then 'Trim(x1hoja.Cells(i, 10).formula) > 0 Then
                debe = 1
            Else
                debe = 0
            End If
