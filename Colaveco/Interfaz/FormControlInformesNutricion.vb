Imports System.IO
Public Class FormControlInformesNutricion
...
#Region "Constructores"
    Public Sub New(ByVal u As dUsuario)
        ...
        Usuario = u
        listarinformesnutricion()
    End Sub

#End Region

    Private Sub listarinformesnutricion()
        Dim cinutricion As New dControlInformesNutricion

        Dim lista As New ArrayList
        lista = cinutricion.listar
        ...
        If Not lista Is Nothing Then
            If lista.Count > 0 Then
                ...
                For Each cinutricion In lista
                    Dim m As New dMuestras
                    Dim ti As New dTipoInforme
                    Dim si As New dSubInforme
                    Dim s As New dSinaveleFicha

                    DataGridView1(columna, fila).Value = cinutricion.ID
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = cinutricion.FECHACONTROL
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = cinutricion.FICHA
                    columna = columna + 1
                    's.FICHA = cimicro.FICHA
                    's = s.buscar
                    ...
                    '    columna = columna + 1
                    'End If
                    DataGridView1(columna, fila).Value = cinutricion.FECHA
                    columna = columna + 1
                    'm.ID = cimicro.MUESTRA
                    'm = m.buscar
                    ...
                    '    columna = columna + 1
                    'End If
                    ti.ID = cinutricion.TIPO
                    ti = ti.buscar
                    DataGridView1(columna, fila).Value = ti.NOMBRE
                    columna = columna + 1
                    'si.ID = cimicro.SUBTIPO
                    'si = si.buscar
                    ...
                    '    columna = columna + 1
                    'End If
                    If cinutricion.RESULTADO = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    If cinutricion.COINCIDE = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    If cinutricion.OM = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    If cinutricion.NC = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = cinutricion.OBSERVACIONES
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = Usuario.NOMBRE
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = "Ver informe"
                    columna = columna + 1
                    If cinutricion.CONTROLADO = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
