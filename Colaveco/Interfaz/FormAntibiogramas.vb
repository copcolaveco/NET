...
#End Region
    ...
    Private Sub guardar()
        ...
        If TextId.Text.Trim.Length > 0 Then
            ...
            a2.FICHA = Val(TextFicha.Text.Trim)
            a2 = a2.buscar
    ...
    Private Sub creainformeexcel()
        ...
        If Not lista Is Nothing Then
            If lista.Count > 0 Then
                ...
                fila = fila + 1
                x1hoja.Cells(fila, columna).formula = "Am: Ampicilina / Amc: Amoxicilina + Ác. Clavulánico / Cf: Cefalotina"
                x1hoja.Cells(fila, columna).HorizontalAlignment = XlHAlign.xlHAlignLeft
                x1hoja.Cells(fila, columna).Font.Size = 8
                fila = fila + 1
                x1hoja.Cells(fila, columna).formula = "E: Eritromicina / Eno: Enrofloxacina / Gm: Gentamicina / Ox: Cloxacilina"
                x1hoja.Cells(fila, columna).HorizontalAlignment = XlHAlign.xlHAlignLeft
                x1hoja.Cells(fila, columna).Font.Size = 8
                fila = fila + 1
                x1hoja.Cells(fila, columna).formula = "P: Penicilina / RAX : Rifaximina / Sxt: Trimetoprim sulfametoxazol / T: Oxytetraciclina"
                x1hoja.Cells(fila, columna).HorizontalAlignment = XlHAlign.xlHAlignLeft
                x1hoja.Cells(fila, columna).Font.Size = 8
                fila = fila + 1
                x1hoja.Cells(fila, columna).formula = "S = Sensible - R = Resistente"
                x1hoja.Cells(fila, columna).HorizontalAlignment = XlHAlign.xlHAlignLeft
                x1hoja.Cells(fila, columna).Font.Bold = True
                x1hoja.Cells(fila, columna).Font.Size = 8
                fila = fila + 1
        ...
        'x1libro.ActiveSheet.pictures.Insert("\\192.168.1.10\E\logo.jpg").select()
        ...
        x1hoja.Cells(13, 4).Formula = "Aislamiento: National Mastitis Council- 3ºEd. 2017"
        x1hoja.Cells(13, 4).Font.Size = 8
        x1hoja.Cells(14, 4).Formula = "Recuento celular: IDF 148-2:2006"
        ...
        'Try
        '    x1hoja.SaveAs("\\SRVDATOS\D\NET\PREINFORMES\ANTIBIOGRAMA\" & idsol & ".xls")
        'Catch ex As System.Net.Mail.SmtpException ' MessageBox.Show(ex.ToString) 
        '    'MessageBox.Show("Falla al grabar!", "Correo", MessageBoxButtons.OK, MessageBoxIcon.Information)
        'End Try
