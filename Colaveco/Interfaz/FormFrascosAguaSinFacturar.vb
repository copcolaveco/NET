Public Class FormFrascosAguaSinFacturar
    ...
    Private Sub cargarlista()
        ...
        lista = ped.listarsinfacturaragua
        ...
        If Not lista Is Nothing Then
            If lista.Count > 0 Then
                ...
                For Each ped In lista
                    ...
                    End If
                    p = Nothing
                    DataGridView1(columna, fila).Value = ped.AGUA
                    columna = columna + 1
    ...
    Private Sub exportar()
        ...
        x1hoja.Cells(fila, columna).Formula = "LISTADO DE FRASCOS DE AGUA SIN FACTURAR"
            ...
            If lista.Count > 0 Then
                For Each ped In lista
                    ...
                    Else
                        ...
                        columna = columna + 1
                    End If
                    x1hoja.Cells(fila, columna).Formula = ped.AGUA
                    x1hoja.Cells(fila, columna).Font.Bold = False
                    x1hoja.Cells(fila, columna).Font.Size = 10
                    x1hoja.Cells(fila, columna).Borders.Color = RGB(0, 0, 0)
                    columna = columna + 1
