...
#End Region
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBuscarNombre.TextChanged
        Dim nombre As String = TextBuscarNombre.Text.Trim
        DataGridView1.Rows.Clear()
    ...
    Private Sub ButtonEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonEliminar.Click
        If TextId.Text <> "" Then
            If MsgBox("El producto será eliminado, ¿desea continuar?", MsgBoxStyle.OkCancel, "Atención") = MsgBoxResult.Ok Then
                Dim p As New dProductos
    ...
    Private Sub TextBuscarCodigo_TextChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBuscarCodigo.TextChanged
        Dim codigo As String = TextBuscarCodigo.Text.Trim
        DataGridView1.Rows.Clear()
        If codigo.Length > 0 Then
            Dim p As New dProductos
            Dim lista As New ArrayList
            lista = p.buscarPorCodigo(codigo)
            If Not lista Is Nothing And lista.Count > 0 Then
                Dim fila As Integer = 0
                Dim columna As Integer = 0
                DataGridView1.Rows.Add(lista.Count)
