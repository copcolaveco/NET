...
#End Region
    ...
    Private Sub BtnListar2020_Click(sender As Object, e As EventArgs) Handles BtnListar2020.Click
        listar2020()
    End Sub

    Public Sub listar2020()
        Dim s As New dSuelos
        Dim sumafosfbray As Double = 0
        Dim sumafosfcitrico As Double = 0
        Dim sumanitratos As Double = 0
        ...
        Dim desde As Date = DtDesde.Value.ToString("yyyy-MM-dd")
        Dim hasta As Date = DtHasta.Value.ToString("yyyy-MM-dd")
        Dim fecdesde As String
        Dim fechasta As String
        fecdesde = Format(desde, "yyyy-MM-dd")
        fechasta = Format(hasta, "yyyy-MM-dd")
        Dim lista As New ArrayList
        lista = s.listarxfecha(fecdesde, fechasta)
        DataGridView1.Rows.Clear()
        ...
        If Not lista Is Nothing Then
            If lista.Count > 0 Then
                ...
                For Each n2 In lista
                    ...
                    '%FOSFORO BRAY
                    If n2.ANALISIS = 131 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                DataGridView1(2, fila).Value = n2.RESULTADO
                                columna = columna + 1
                                fila = fila + 1
                                sumafosfbray = sumafosfbray + n2.RESULTADO
                                cuentafosfbray = cuentafosfbray + 1
                                productofosfbray = productofosfbray * n2.RESULTADO
                            Else
                                DataGridView1(2, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                                sumafosfbray = sumafosfbray + n2.RESULTADO
                                cuentafosfbray = cuentafosfbray + 1
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                DataGridView1(2, fila).Value = n2.RESULTADO2
                                columna = columna + 1
                                fila = fila + 1
                                sumafosfbray = sumafosfbray + n2.RESULTADO2
                                cuentafosfbray = cuentafosfbray + 1
                                productofosfbray = productofosfbray * n2.RESULTADO2
                            Else
                                DataGridView1(2, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    '%FOSFORO CITRICO
                    If n2.ANALISIS = 132 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                DataGridView1(3, fila).Value = n2.RESULTADO
                                columna = columna + 1
                                fila = fila + 1
                                sumafosfcitrico = sumafosfcitrico + n2.RESULTADO
                                cuentafosfcitrico = cuentafosfcitrico + 1
                                productofosfcitrico = productofosfcitrico * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumafosfcitrico = sumafosfcitrico + n2.RESULTADO2
                                cuentafosfcitrico = cuentafosfcitrico + 1
                                productofosfcitrico = productofosfcitrico * n2.RESULTADO2
                            Else
                                DataGridView1(3, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    '%NITRATOS
                    If n2.ANALISIS = 133 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                DataGridView1(4, fila).Value = n2.RESULTADO
                                columna = columna + 1
                                fila = fila + 1
                                sumanitratos = sumanitratos + n2.RESULTADO
                                cuentanitratos = cuentanitratos + 1
                                productonitratos = productonitratos * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumanitratos = sumanitratos + n2.RESULTADO2
                                cuentanitratos = cuentanitratos + 1
                                productonitratos = productonitratos * n2.RESULTADO2
                            Else
                                DataGridView1(4, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    '%PH AGUA
                    If n2.ANALISIS = 134 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                DataGridView1(5, fila).Value = n2.RESULTADO
                                columna = columna + 1
                                fila = fila + 1
                                sumaphagua = sumaphagua + n2.RESULTADO
                                cuentaphagua = cuentaphagua + 1
                                productophagua = productophagua * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumaphagua = sumaphagua + n2.RESULTADO2
                                cuentaphagua = cuentaphagua + 1
                                productophagua = productophagua * n2.RESULTADO2
                            Else
                                DataGridView1(5, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    '%PH CLORURO DE POTASIO
                    If n2.ANALISIS = 135 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                DataGridView1(6, fila).Value = n2.RESULTADO
                                columna = columna + 1
                                fila = fila + 1
                                sumaphkci = sumaphkci + n2.RESULTADO
                                cuentaphkci = cuentaphkci + 1
                                productophkci = productophkci * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumaphkci = sumaphkci + n2.RESULTADO2
                                cuentaphkci = cuentaphkci + 1
                                productophkci = productophkci * n2.RESULTADO2
                            Else
                                DataGridView1(6, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    If n2.ANALISIS = 136 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumapotasioint = sumapotasioint + n2.RESULTADO
                                cuentapotasioint = cuentapotasioint + 1
                                productopotasioint = productopotasioint * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumapotasioint = sumapotasioint + n2.RESULTADO2
                                cuentapotasioint = cuentapotasioint + 1
                                productopotasioint = productopotasioint * n2.RESULTADO2
                            Else
                                DataGridView1(7, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    If n2.ANALISIS = 137 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumasulfatos = sumasulfatos + n2.RESULTADO
                                cuentasulfatos = cuentasulfatos + 1
                                productosulfatos = productosulfatos * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumasulfatos = sumasulfatos + n2.RESULTADO2
                                cuentasulfatos = cuentasulfatos + 1
                                productosulfatos = productosulfatos * n2.RESULTADO2
                            Else
                                DataGridView1(8, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    '% NITROGENO TOTAL
                    If n2.ANALISIS = 475 Or n2.ANALISIS = 374 Or n2.ANALISIS = 461 Or n2.ANALISIS = 462 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                DataGridView1(9, fila).Value = n2.RESULTADO
                                columna = columna + 1
                                fila = fila + 1
                                sumanitrogenoveg = sumanitrogenoveg + n2.RESULTADO
                                cuentanitrogenoveg = cuentanitrogenoveg + 1
                                productonitrogenoveg = productonitrogenoveg * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumanitrogenoveg = sumanitrogenoveg + n2.RESULTADO2
                                cuentanitrogenoveg = cuentanitrogenoveg + 1
                                productonitrogenoveg = productonitrogenoveg * n2.RESULTADO2
                            Else
                                DataGridView1(9, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    '% CARBONO ORGANICO
                    If n2.ANALISIS = 460 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                DataGridView1(10, fila).Value = n2.RESULTADO
                                columna = columna + 1
                                fila = fila + 1
                                sumacarbonoorg = sumacarbonoorg + n2.RESULTADO
                                cuentacarbonoorg = cuentacarbonoorg + 1
                                productocarbonoorg = productocarbonoorg * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumacarbonoorg = sumacarbonoorg + n2.RESULTADO2
                                cuentacarbonoorg = cuentacarbonoorg + 1
                                productocarbonoorg = productocarbonoorg * n2.RESULTADO2
                            Else
                                DataGridView1(10, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    If n2.ANALISIS = 139 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumamateriaorg = sumamateriaorg + n2.RESULTADO
                                cuentamateriaorg = cuentamateriaorg + 1
                                productomateriaorg = productomateriaorg * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumamateriaorg = sumamateriaorg + n2.RESULTADO2
                                cuentamateriaorg = cuentamateriaorg + 1
                                productomateriaorg = productomateriaorg * n2.RESULTADO2
                            Else
                                DataGridView1(11, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    If n2.ANALISIS = 140 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumapmn = sumapmn + n2.RESULTADO
                                cuentapmn = cuentapmn + 1
                                productopmn = productopmn * n2.RESULTADO
                            Else
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                ...
                                columna = columna + 1
                                fila = fila + 1
                                sumapmn = sumapmn + n2.RESULTADO2
                                cuentapmn = cuentapmn + 1
                                productopmn = productopmn * n2.RESULTADO2
                            Else
                                DataGridView1(12, fila).Value = "-"
                                columna = columna + 1
                                fila = fila + 1
                    ...
                    If n2.ANALISIS = 146 Then
                        If IsNumeric(n2.RESULTADO) Then
                            ...
                            fila = fila + 1
                            sumacalcio = sumacalcio + n2.RESULTADO
                            cuentacalcio = cuentacalcio + 1
                            productocalcio = productocalcio * n2.RESULTADO
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            DataGridView1(13, fila).Value = n2.RESULTADO2
                            fila = fila + 1
                            sumacalcio = sumacalcio + n2.RESULTADO2
                            cuentacalcio = cuentacalcio + 1
                            productocalcio = productocalcio * n2.RESULTADO2
                        End If
                    End If

                    '%MAGNECIO
                    If n2.ANALISIS = 147 Then
                        If IsNumeric(n2.RESULTADO) Then
                            DataGridView1(14, fila).Value = n2.RESULTADO
                            columna = columna + 1
                            fila = fila + 1
                            sumamagnesio = sumamagnesio + n2.RESULTADO
                            cuentamagnesio = cuentamagnesio + 1
                            productomagnesio = productomagnesio * n2.RESULTADO
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            DataGridView1(14, fila).Value = n2.RESULTADO2
                            columna = columna + 1
                            fila = fila + 1
                            sumamagnesio = sumamagnesio + n2.RESULTADO2
                            cuentamagnesio = cuentamagnesio + 1
                            productomagnesio = productomagnesio * n2.RESULTADO2
                        End If
                    End If

                    '% SODIO
                    If n2.ANALISIS = 148 Then
                        If IsNumeric(n2.RESULTADO) Then
                            DataGridView1(15, fila).Value = n2.RESULTADO
                            fila = fila + 1
                            sumasodio = sumasodio + n2.RESULTADO
                            cuentasodio = cuentasodio + 1
                            productosodio = productosodio * n2.RESULTADO
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            DataGridView1(15, fila).Value = n2.RESULTADO2
                            fila = fila + 1
                            sumasodio = sumasodio + n2.RESULTADO2
                            cuentasodio = cuentasodio + 1
                            productosodio = productosodio * n2.RESULTADO2
                        End If
                    End If
                    ...
                    If n2.ANALISIS = 279 Then
                        If IsNumeric(n2.RESULTADO) Then
                            ...
                            fila = fila + 1
                            sumaacideztit = sumaacideztit + n2.RESULTADO
                            cuentaacideztit = cuentaacideztit + 1
                            productoacideztit = productoacideztit * n2.RESULTADO
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            DataGridView1(16, fila).Value = n2.RESULTADO2
                            fila = fila + 1
                            sumaacideztit = sumaacideztit + n2.RESULTADO2
                            cuentaacideztit = cuentaacideztit + 1
                            productoacideztit = productoacideztit * n2.RESULTADO2
                        End If
                    End If

                    '% CIC
                    If n2.ANALISIS = 280 Then
                        If IsNumeric(n2.RESULTADO) Then
                            DataGridView1(17, fila).Value = n2.RESULTADO
                            fila = fila + 1
                            sumacic = sumacic + n2.RESULTADO
                            cuentacic = cuentacic + 1
                            productocic = productocic * n2.RESULTADO
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            DataGridView1(17, fila).Value = n2.RESULTADO2
                            fila = fila + 1
                            sumacic = sumacic + n2.RESULTADO2
                            cuentacic = cuentacic + 1
                            productocic = productocic * n2.RESULTADO2
                        End If
                    End If
                    ...
                    If n2.ANALISIS = 281 Then
                        If IsNumeric(n2.RESULTADO) Then
                            DataGridView1(18, fila).Value = n2.RESULTADO
                            fila = fila + 1
                            sumasb = sumasb + n2.RESULTADO
                            cuentasb = cuentasb + 1
                            productosb = productosb * n2.RESULTADO
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            DataGridView1(18, fila).Value = n2.RESULTADO2
                            fila = fila + 1
                            sumasb = sumasb + n2.RESULTADO2
                            cuentasb = cuentasb + 1
                            productosb = productosb * n2.RESULTADO2
                        End If
                    End If
                Next
                If sumafosfbray <> 0 And cuentafosfbray <> 0 Then
                ...
                For Each n2 In lista
                    If n2.ANALISIS = 131 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvfosfbray = n2.RESULTADO - mediafosfbray
                                cuadfosfbray = desvfosfbray * desvfosfbray
                                sumacuadfosfbray = sumacuadfosfbray + cuadfosfbray
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvfosfbray = n2.RESULTADO2 - mediafosfbray
                                cuadfosfbray = desvfosfbray * desvfosfbray
                                sumacuadfosfbray = sumacuadfosfbray + cuadfosfbray
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 132 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvfosfcitrico = n2.RESULTADO - mediafosfcitrico
                                cuadfosfcitrico = desvfosfcitrico * desvfosfcitrico
                                sumacuadfosfcitrico = sumacuadfosfcitrico + cuadfosfcitrico
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvfosfcitrico = n2.RESULTADO2 - mediafosfcitrico
                                cuadfosfcitrico = desvfosfcitrico * desvfosfcitrico
                                sumacuadfosfcitrico = sumacuadfosfcitrico + cuadfosfcitrico
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 133 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvnitratos = n2.RESULTADO - medianitratos
                                cuadnitratos = desvnitratos * desvnitratos
                                sumacuadnitratos = sumacuadnitratos + cuadnitratos
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvnitratos = n2.RESULTADO2 - medianitratos
                                cuadnitratos = desvnitratos * desvnitratos
                                sumacuadnitratos = sumacuadnitratos + cuadnitratos
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 134 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvphagua = n2.RESULTADO - mediaphagua
                                cuadphagua = desvphagua * desvphagua
                                sumacuadphagua = sumacuadphagua + cuadphagua
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvphagua = n2.RESULTADO2 - mediaphagua
                                cuadphagua = desvphagua * desvphagua
                                sumacuadphagua = sumacuadphagua + cuadphagua
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 135 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvphkci = n2.RESULTADO - mediaphkci
                                cuadphkci = desvphkci * desvphkci
                                sumacuadphkci = sumacuadphkci + cuadphkci
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvphkci = n2.RESULTADO2 - mediaphkci
                                cuadphkci = desvphkci * desvphkci
                                sumacuadphkci = sumacuadphkci + cuadphkci
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 136 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvpotasioint = n2.RESULTADO - mediapotasioint
                                cuadpotasioint = desvpotasioint * desvpotasioint
                                sumacuadpotasioint = sumacuadpotasioint + cuadpotasioint
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvpotasioint = n2.RESULTADO2 - mediapotasioint
                                cuadpotasioint = desvpotasioint * desvpotasioint
                                sumacuadpotasioint = sumacuadpotasioint + cuadpotasioint
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 137 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvsulfatos = n2.RESULTADO - mediasulfatos
                                cuadsulfatos = desvsulfatos * desvsulfatos
                                sumacuadsulfatos = sumacuadsulfatos + cuadsulfatos
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvsulfatos = n2.RESULTADO2 - mediasulfatos
                                cuadsulfatos = desvsulfatos * desvsulfatos
                                sumacuadsulfatos = sumacuadsulfatos + cuadsulfatos
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 475 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvnitrogenoveg = n2.RESULTADO - medianitrogenoveg
                                cuadnitrogenoveg = desvnitrogenoveg * desvnitrogenoveg
                                sumacuadnitrogenoveg = sumacuadnitrogenoveg + cuadnitrogenoveg
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvnitrogenoveg = n2.RESULTADO2 - medianitrogenoveg
                                cuadnitrogenoveg = desvnitrogenoveg * desvnitrogenoveg
                                sumacuadnitrogenoveg = sumacuadnitrogenoveg + cuadnitrogenoveg
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 460 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvcarbonoorg = n2.RESULTADO - mediacarbonoorg
                                cuadcarbonoorg = desvcarbonoorg * desvcarbonoorg
                                sumacuadcarbonoorg = sumacuadcarbonoorg + cuadcarbonoorg
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvcarbonoorg = n2.RESULTADO2 - mediacarbonoorg
                                cuadcarbonoorg = desvcarbonoorg * desvcarbonoorg
                                sumacuadcarbonoorg = sumacuadcarbonoorg + cuadcarbonoorg
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 139 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvmateriaorg = n2.RESULTADO - mediamateriaorg
                                cuadmateriaorg = desvmateriaorg * desvmateriaorg
                                sumacuadmateriaorg = sumacuadmateriaorg + cuadmateriaorg
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvmateriaorg = n2.RESULTADO2 - mediamateriaorg
                                cuadmateriaorg = desvmateriaorg * desvmateriaorg
                                sumacuadmateriaorg = sumacuadmateriaorg + cuadmateriaorg
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 140 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvpmn = n2.RESULTADO - mediapmn
                                cuadpmn = desvpmn * desvpmn
                                sumacuadpmn = sumacuadpmn + cuadpmn
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvpmn = n2.RESULTADO2 - mediapmn
                                cuadpmn = desvpmn * desvpmn
                                sumacuadpmn = sumacuadpmn + cuadpmn
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 146 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvcalcio = n2.RESULTADO - mediacalcio
                                cuadcalcio = desvcalcio * desvcalcio
                                sumacuadcalcio = sumacuadcalcio + cuadcalcio
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvcalcio = n2.RESULTADO2 - mediacalcio
                                cuadcalcio = desvcalcio * desvcalcio
                                sumacuadcalcio = sumacuadcalcio + cuadcalcio
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 147 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvmagnesio = n2.RESULTADO - mediamagnesio
                                cuadmagnesio = desvmagnesio * desvmagnesio
                                sumacuadmagnesio = sumacuadmagnesio + cuadmagnesio
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvmagnesio = n2.RESULTADO2 - mediamagnesio
                                cuadmagnesio = desvmagnesio * desvmagnesio
                                sumacuadmagnesio = sumacuadmagnesio + cuadmagnesio
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 148 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvsodio = n2.RESULTADO - mediasodio
                                cuadsodio = desvsodio * desvsodio
                                sumacuadsodio = sumacuadsodio + cuadsodio
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvsodio = n2.RESULTADO2 - mediasodio
                                cuadsodio = desvsodio * desvsodio
                                sumacuadsodio = sumacuadsodio + cuadsodio
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 279 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvacideztit = n2.RESULTADO - mediaacideztit
                                cuadacideztit = desvacideztit * desvacideztit
                                sumacuadacideztit = sumacuadacideztit + cuadacideztit
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvacideztit = n2.RESULTADO2 - mediaacideztit
                                cuadacideztit = desvacideztit * desvacideztit
                                sumacuadacideztit = sumacuadacideztit + cuadacideztit
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 280 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvcic = n2.RESULTADO - mediacic
                                cuadcic = desvcic * desvcic
                                sumacuadcic = sumacuadcic + cuadcic
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvcic = n2.RESULTADO2 - mediacic
                                cuadcic = desvcic * desvcic
                                sumacuadcic = sumacuadcic + cuadcic
                            End If
                        End If
                    ...
                    If n2.ANALISIS = 281 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                desvsb = n2.RESULTADO - mediasb
                                cuadsb = desvsb * desvsb
                                sumacuadsb = sumacuadsb + cuadsb
                            End If
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                desvsb = n2.RESULTADO2 - mediasb
                                cuadsb = desvsb * desvsb
                                sumacuadsb = sumacuadsb + cuadsb
                            End If
                        End If
                ...
                columna = columna + 1
                If mediafosfbray <> 0 Then
                    DataGridView1(2, fila).Value = Math.Round(mediafosfbray, 2)
                    columna = columna + 1
                Else
                    DataGridView1(2, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediafosfcitrico <> 0 Then
                    DataGridView1(3, fila).Value = Math.Round(mediafosfcitrico, 2)
                    columna = columna + 1
                Else
                    DataGridView1(3, fila).Value = "-"
                    columna = columna + 1
                End If
                If medianitratos <> 0 Then
                    DataGridView1(4, fila).Value = Math.Round(medianitratos, 2)
                    columna = columna + 1
                Else
                    DataGridView1(4, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediaphagua <> 0 Then
                    DataGridView1(5, fila).Value = Math.Round(mediaphagua, 2)
                    columna = columna + 1
                Else
                    DataGridView1(5, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediaphkci <> 0 Then
                    DataGridView1(6, fila).Value = Math.Round(mediaphkci, 2)
                    columna = columna + 1
                Else
                    DataGridView1(6, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediapotasioint <> 0 Then
                    DataGridView1(7, fila).Value = Math.Round(mediapotasioint, 2)
                    columna = columna + 1
                Else
                    DataGridView1(7, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediasulfatos <> 0 Then
                    DataGridView1(8, fila).Value = Math.Round(mediasulfatos, 2)
                    columna = columna + 1
                Else
                    DataGridView1(8, fila).Value = "-"
                    columna = columna + 1
                End If
                If medianitrogenoveg <> 0 Then
                    DataGridView1(9, fila).Value = Math.Round(medianitrogenoveg, 2)
                    columna = columna + 1
                Else
                    DataGridView1(9, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediacarbonoorg <> 0 Then
                    DataGridView1(10, fila).Value = Math.Round(mediacarbonoorg, 2)
                    columna = columna + 1
                Else
                    DataGridView1(10, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediamateriaorg <> 0 Then
                    DataGridView1(11, fila).Value = Math.Round(mediamateriaorg, 2)
                    columna = columna + 1
                Else
                    DataGridView1(11, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediapmn <> 0 Then
                    DataGridView1(12, fila).Value = Math.Round(mediapmn, 2)
                    columna = columna + 1
                Else
                    DataGridView1(12, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediacalcio <> 0 Then
                    DataGridView1(13, fila).Value = Math.Round(mediacalcio, 2)
                    columna = columna + 1
                Else
                ...
                End If
                If mediamagnesio <> 0 Then
                    DataGridView1(14, fila).Value = Math.Round(mediamagnesio, 2)
                    columna = columna + 1
                Else
                ...
                End If
                If mediasodio <> 0 Then
                    DataGridView1(15, fila).Value = Math.Round(mediasodio, 2)
                    columna = columna + 1
                Else
                ...
                End If
                If mediaacideztit <> 0 Then
                    DataGridView1(16, fila).Value = Math.Round(mediaacideztit, 2)
                    columna = columna + 1
                Else
                ...
                End If
                If mediacic <> 0 Then
                    DataGridView1(17, fila).Value = Math.Round(mediacic, 2)
                    columna = columna + 1
                Else
                    DataGridView1(17, fila).Value = "-"
                    columna = columna + 1
                End If
                If mediasb <> 0 Then
                    DataGridView1(18, fila).Value = Math.Round(mediasb, 2)
                    columna = 1
                    fila = fila + 1
                Else
                    DataGridView1(18, fila).Value = "-"
                    columna = 1
                    fila = fila + 1
                End If
                ...
                columna = columna + 1
                If desvestfosfbray <> 0 Then
                    DataGridView1(2, fila).Value = Math.Round(desvestfosfbray, 2)
                    columna = columna + 1
                Else
                    DataGridView1(2, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestfosfcitrico <> 0 Then
                    DataGridView1(3, fila).Value = Math.Round(desvestfosfcitrico, 2)
                    columna = columna + 1
                Else
                    DataGridView1(3, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestnitratos <> 0 Then
                    DataGridView1(4, fila).Value = Math.Round(desvestnitratos, 2)
                    columna = columna + 1
                Else
                    DataGridView1(4, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestphagua <> 0 Then
                    DataGridView1(5, fila).Value = Math.Round(desvestphagua, 2)
                    columna = columna + 1
                Else
                    DataGridView1(5, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestphkci <> 0 Then
                    DataGridView1(6, fila).Value = Math.Round(desvestphkci, 2)
                    columna = columna + 1
                Else
                    DataGridView1(6, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestpotasioint <> 0 Then
                    DataGridView1(7, fila).Value = Math.Round(desvestpotasioint, 2)
                    columna = columna + 1
                Else
                    DataGridView1(7, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestsulfatos <> 0 Then
                    DataGridView1(8, fila).Value = Math.Round(desvestsulfatos, 2)
                    columna = columna + 1
                Else
                    DataGridView1(8, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestnitrogenoveg <> 0 Then
                    DataGridView1(9, fila).Value = Math.Round(desvestnitrogenoveg, 2)
                    columna = columna + 1
                Else
                    DataGridView1(9, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestcarbonoorg <> 0 Then
                    DataGridView1(10, fila).Value = Math.Round(desvestcarbonoorg, 2)
                    columna = columna + 1
                Else
                    DataGridView1(10, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestmateriaorg <> 0 Then
                    DataGridView1(11, fila).Value = Math.Round(desvestmateriaorg, 2)
                    columna = columna + 1
                Else
                    DataGridView1(11, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestpmn <> 0 Then
                    DataGridView1(12, fila).Value = Math.Round(desvestpmn, 2)
                    columna = columna + 1
                Else
                    DataGridView1(12, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestcalcio <> 0 Then
                    DataGridView1(13, fila).Value = Math.Round(desvestcalcio, 2)
                    columna = columna + 1
                Else
                    DataGridView1(13, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestmagnesio <> 0 Then
                    DataGridView1(14, fila).Value = Math.Round(desvestmagnesio, 2)
                    columna = columna + 1
                Else
                    DataGridView1(14, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestsodio <> 0 Then
                    DataGridView1(15, fila).Value = Math.Round(desvestsodio, 2)
                    columna = columna + 1
                Else
                    DataGridView1(15, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestacideztit <> 0 Then
                    DataGridView1(16, fila).Value = Math.Round(desvestacideztit, 2)
                    columna = columna + 1
                Else
                    DataGridView1(16, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestcic <> 0 Then
                    DataGridView1(17, fila).Value = Math.Round(desvestcic, 2)
                    columna = columna + 1
                Else
                    DataGridView1(17, fila).Value = "-"
                    columna = columna + 1
                End If
                If desvestsb <> 0 Then
                    DataGridView1(18, fila).Value = Math.Round(desvestsb, 2)
                    columna = 1
                    fila = fila + 1
                Else
                    DataGridView1(18, fila).Value = "-"
                ...
                columna = columna + 1
                If medgeomfosfbray <> 1 Then
                    DataGridView1(2, fila).Value = Math.Round(medgeomfosfbray, 2)
                    columna = columna + 1
                Else
                    DataGridView1(2, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomfosfcitrico <> 1 Then
                    DataGridView1(3, fila).Value = Math.Round(medgeomfosfcitrico, 2)
                    columna = columna + 1
                Else
                    DataGridView1(3, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomnitratos <> 1 Then
                    DataGridView1(4, fila).Value = Math.Round(medgeomnitratos, 2)
                    columna = columna + 1
                Else
                    DataGridView1(4, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomphagua <> 1 Then
                    DataGridView1(5, fila).Value = Math.Round(medgeomphagua, 2)
                    columna = columna + 1
                Else
                    DataGridView1(5, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomphkci <> 1 Then
                    DataGridView1(6, fila).Value = Math.Round(medgeomphkci, 2)
                    columna = columna + 1
                Else
                    DataGridView1(6, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeompotasioint <> 1 Then
                    DataGridView1(7, fila).Value = Math.Round(medgeompotasioint, 2)
                    columna = columna + 1
                Else
                    DataGridView1(7, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomsulfatos <> 1 Then
                    DataGridView1(8, fila).Value = Math.Round(medgeomsulfatos, 2)
                    columna = columna + 1
                Else
                    DataGridView1(8, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomnitrogenoveg <> 1 Then
                    DataGridView1(9, fila).Value = Math.Round(medgeomnitrogenoveg, 2)
                    columna = columna + 1
                Else
                    DataGridView1(9, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomcarbonoorg <> 1 Then
                    DataGridView1(10, fila).Value = Math.Round(medgeomcarbonoorg, 2)
                    columna = columna + 1
                Else
                    DataGridView1(10, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeommateriaorg <> 1 Then
                    DataGridView1(11, fila).Value = Math.Round(medgeommateriaorg, 2)
                    columna = columna + 1
                Else
                    DataGridView1(11, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeompmn <> 1 Then
                    DataGridView1(12, fila).Value = Math.Round(medgeompmn, 2)
                    columna = columna + 1
                Else
                    DataGridView1(12, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomcalcio <> 1 Then
                    DataGridView1(13, fila).Value = Math.Round(medgeomcalcio, 2)
                    columna = columna + 1
                Else
                    DataGridView1(13, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeommagnesio <> 1 Then
                    DataGridView1(14, fila).Value = Math.Round(medgeommagnesio, 2)
                    columna = columna + 1
                Else
                    DataGridView1(14, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomsodio <> 1 Then
                    DataGridView1(15, fila).Value = Math.Round(medgeomsodio, 2)
                    columna = columna + 1
                Else
                    DataGridView1(15, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomacideztit <> 1 Then
                    DataGridView1(16, fila).Value = Math.Round(medgeomacideztit, 2)
                    columna = columna + 1
                Else
                    DataGridView1(16, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomcic <> 1 Then
                    DataGridView1(17, fila).Value = Math.Round(medgeomcic, 2)
                    columna = columna + 1
                Else
                    DataGridView1(17, fila).Value = "-"
                    columna = columna + 1
                End If
                If medgeomsb <> 1 Then
                    DataGridView1(18, fila).Value = Math.Round(medgeomsb, 2)
                    columna = 0
                Else
                    DataGridView1(18, fila).Value = "-"
                    columna = 0
    ...
    Private Sub BtnExcelExportar_Click(sender As Object, e As EventArgs) Handles BtnExcelExportar.Click
        ExportarSuelos2020()
    End Sub

    Private Sub ExportarSuelos2020()
        Dim x1app As Microsoft.Office.Interop.Excel.Application
        Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
        Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
        x1app = CType(CreateObject("Excel.Application"), Microsoft.Office.Interop.Excel.Application)
            ...
            If lista.Count > 0 Then
                For Each n2 In lista
                    ...
                    If n2.ANALISIS = 137 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                x1hoja.Cells(fila, 8).formula = n2.RESULTADO
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                x1hoja.Cells(fila, 8).formula = n2.RESULTADO2
                                x1hoja.Cells(fila, 8).HorizontalAlignment = XlHAlign.xlHAlignLeft
                                x1hoja.Cells(fila, 8).Font.Bold = False
                                x1hoja.Cells(fila, 8).Font.Size = 10
                                x1hoja.Cells(fila, 8).BORDERS.color = RGB(255, 0, 0)
                    ...
                    If n2.ANALISIS = 279 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                x1hoja.Cells(fila, 16).formula = n2.RESULTADO
                                x1hoja.Cells(fila, 16).HorizontalAlignment = XlHAlign.xlHAlignLeft
                                x1hoja.Cells(fila, 16).Font.Bold = False
                                x1hoja.Cells(fila, 16).Font.Size = 10
                                x1hoja.Cells(fila, 16).BORDERS.color = RGB(255, 0, 0)
                                sumaacideztit = sumaacideztit + n2.RESULTADO
                                cuentaacideztit = cuentaacideztit + 1
                                productoacideztit = productoacideztit * n2.RESULTADO
                                columna = columna + 1
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                x1hoja.Cells(fila, 16).formula = n2.RESULTADO2
                                x1hoja.Cells(fila, 16).HorizontalAlignment = XlHAlign.xlHAlignLeft
                                x1hoja.Cells(fila, 16).Font.Bold = False
                                x1hoja.Cells(fila, 16).Font.Size = 10
                                x1hoja.Cells(fila, 16).BORDERS.color = RGB(255, 0, 0)
                    ...
                    If n2.ANALISIS = 280 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                x1hoja.Cells(fila, 17).formula = n2.RESULTADO
                                x1hoja.Cells(fila, 17).HorizontalAlignment = XlHAlign.xlHAlignLeft
                                x1hoja.Cells(fila, 17).Font.Bold = False
                                x1hoja.Cells(fila, 17).Font.Size = 10
                                x1hoja.Cells(fila, 17).BORDERS.color = RGB(255, 0, 0)
                                sumacic = sumacic + n2.RESULTADO
                                cuentacic = cuentacic + 1
                                productocic = productocic * n2.RESULTADO
                                columna = columna + 1
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                x1hoja.Cells(fila, 17).formula = n2.RESULTADO2
                                x1hoja.Cells(fila, 17).HorizontalAlignment = XlHAlign.xlHAlignLeft
                                x1hoja.Cells(fila, 17).Font.Bold = False
                                x1hoja.Cells(fila, 17).Font.Size = 10
                                x1hoja.Cells(fila, 17).BORDERS.color = RGB(255, 0, 0)
                    ...
                    If n2.ANALISIS = 281 Then
                        If IsNumeric(n2.RESULTADO) Then
                            If n2.RESULTADO <> -1 Then
                                x1hoja.Cells(fila, 18).formula = n2.RESULTADO
                                x1hoja.Cells(fila, 18).HorizontalAlignment = XlHAlign.xlHAlignLeft
                                x1hoja.Cells(fila, 18).Font.Bold = False
                                x1hoja.Cells(fila, 18).Font.Size = 10
                                x1hoja.Cells(fila, 18).BORDERS.color = RGB(255, 0, 0)
                                sumasb = sumasb + n2.RESULTADO
                                cuentasb = cuentasb + 1
                                productosb = productosb * n2.RESULTADO
                                columna = columna + 1
                        ...
                        ElseIf IsNumeric(n2.RESULTADO2) Then
                            If n2.RESULTADO2 <> -1 Then
                                x1hoja.Cells(fila, 18).formula = n2.RESULTADO2
                                x1hoja.Cells(fila, 18).HorizontalAlignment = XlHAlign.xlHAlignLeft
                                x1hoja.Cells(fila, 18).Font.Bold = False
                                x1hoja.Cells(fila, 18).Font.Size = 10
                                x1hoja.Cells(fila, 18).BORDERS.color = RGB(255, 0, 0)
