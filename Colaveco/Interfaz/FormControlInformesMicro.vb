Imports System.IO
Public Class FormControlInformesMicro
...
#End Region
    ...
    Private Sub listarinformesmicro()
        Dim cimicro As New dControlInformesMicro

        Dim lista As New ArrayList
        lista = cimicro.listar
        ...
        If Not lista Is Nothing Then
            If lista.Count > 0 Then
                ...
                For Each cimicro In lista
                    Dim m As New dMuestras
                    Dim ti As New dTipoInforme
                    Dim si As New dSubInforme
                    Dim s As New dSinaveleFicha

                    DataGridView1(columna, fila).Value = cimicro.ID
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = cimicro.FECHACONTROL
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = cimicro.FICHA
                    columna = columna + 1
                    ...
                    '    columna = columna + 1
                    'End If
                    DataGridView1(columna, fila).Value = cimicro.FECHA
                    columna = columna + 1
                    ...
                    '    columna = columna + 1
                    'End If
                    If cimicro.RESULTADO = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    If cimicro.COINCIDE = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    If cimicro.OM = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    If cimicro.NC = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = cimicro.OBSERVACIONES
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = Usuario.NOMBRE
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = "Ver informe"
                    columna = columna + 1
                    If cimicro.CONTROLADO = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
