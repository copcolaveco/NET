Imports System.IO
Public Class FormControlInformesSuelos
...
#End Region
    ...
    Private Sub listarinformessuelos()
        Dim cisuelos As New dControlInformesSuelos

        Dim lista As New ArrayList
        lista = cisuelos.listar
        ...
        If Not lista Is Nothing Then
            If lista.Count > 0 Then
                ...
                For Each cisuelos In lista
                    Dim m As New dMuestras
                    Dim ti As New dTipoInforme
                    Dim si As New dSubInforme
                    Dim s As New dSinaveleFicha

                    DataGridView1(columna, fila).Value = cisuelos.ID
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = cisuelos.FECHACONTROL
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = cisuelos.FICHA
                    columna = columna + 1
                    ...
                    '    columna = columna + 1
                    'End If
                    DataGridView1(columna, fila).Value = cisuelos.FECHA
                    columna = columna + 1
                    ...
                    '    columna = columna + 1
                    'End If
                    If cisuelos.RESULTADO = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    If cisuelos.COINCIDE = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    If cisuelos.OM = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    If cisuelos.NC = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = cisuelos.OBSERVACIONES
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = Usuario.NOMBRE
                    columna = columna + 1
                    DataGridView1(columna, fila).Value = "Ver informe"
                    columna = columna + 1
                    If cisuelos.CONTROLADO = 0 Then
                        DataGridView1(columna, fila).Value = False
                    Else
                        DataGridView1(columna, fila).Value = True
                    End If
