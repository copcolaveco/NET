...
#End Region
    ...
    Private Sub agregarlinea()
        ...
        If TextPrecio.Text > 0 Then
            precio = TextPrecio.Text.Trim
        Else
            MsgBox("Debe ingresar el precio actual!")
            Exit Sub
            TextPrecio.Focus()
        End If
    ...
    Private Sub ButtonEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonEliminar.Click
        ...
        c.eliminar(Usuario)
        lc.IDCOMPRA = id
        lc.eliminarxcompra(Usuario)
        limpiar()
        limpiar2()
    End Sub

    Private Sub ButtonBuscarCompra_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonBuscarCompra.Click
        limpiar()
        limpiar2()
        Dim v As New FormBuscarCompras
        v.ShowDialog()
        If Not v.Compras Is Nothing Then
            Dim c As dCompras = v.Compras
            TextId.Text = c.ID
            DateFecha.Value = c.FECHA
            TextIdProveedor.Text = c.PROVEEDOR
            Dim p As New dProveedores
            p.ID = c.PROVEEDOR
            p = p.buscar
            If Not p Is Nothing Then
                TextProveedor.Text = p.NOMBRE
            End If
            ComboEmail.Text = c.EMAIL
            listarlineas()
        End If
    End Sub

    Private Sub FormCompras_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
