...
#End Region
    ...
    Private Sub desmarcarcheckbox()
        ...
        CheckSalmonellaPool.Checked = False
        CheckListeriaPool.Checked = False
    End Sub
    ...
    Private Sub ButtonGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonGuardar.Click
        ...
        Dim salmonellapool As Integer = 0
        Dim listeriapool As Integer = 0
        ...
        Else
            ecoli = 0
        End If
        If CheckEcoli157.Checked = True Then
            ecoli157 = 1
        Else
            ecoli157 = 0
        End If
        ...
        Else
            cenizas = 0
        End If
        If CheckSalmonellaPool.Checked = True Then
            salmonellapool = 1
        Else
            salmonellapool = 0
        End If
        If CheckListeriaPool.Checked = True Then
            listeriapool = 1
        Else
            listeriapool = 0
        End If
        ...
        s.CENIZAS = cenizas
        s.SALMONELLAPOOL = salmonellapool
        s.LISTERIAPOOL = listeriapool
        s.MARCA = 0
