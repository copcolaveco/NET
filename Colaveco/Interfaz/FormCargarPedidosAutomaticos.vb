...
#End Region
    ...
    Private Sub ButtonCargar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonCargar.Click
        ...
        Dim result = MessageBox.Show("Verifique que los pedidos automáticos no se hayan cargado previamente, si ya lo hizo presione Yes, de lo contrario presione No.", "Atención!", MessageBoxButtons.YesNo)
        If result = DialogResult.No Then
            Dim v As New FormEnvioCajas(Usuario)
            v.ShowDialog()
