...
#End Region
    ...
    Private Sub creainformeexcel()
        ...
        Dim Arch As String
        Arch = "\\ROBOT\PREINFORMES\CALIDAD\" & idsol & ".xls"
        id_sol = idsol
        ...
        x1hoja.Cells(fila, columna).formula = "* Ensayos no acreditados ISO 17.025 por O.U.A."
        x1hoja.Cells(fila, columna).HorizontalAlignment = XlHAlign.xlHAlignLeft
        x1hoja.Cells(fila, columna).Font.Size = 6
        fila = fila + 1
    ...
    Private Function preciotimbre() As Double
