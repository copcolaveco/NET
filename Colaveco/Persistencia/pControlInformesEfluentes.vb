Public Class pControlInformesEfluentes
    ...
    Public Function guardar(ByVal o As Object) As Boolean
        ...
        Dim sqlVerificar As String = "SELECT COUNT(*) FROM controlinformesefluentes WHERE ficha = " & obj.FICHA
        ...
        If ds IsNot Nothing AndAlso ds.Tables.Count > 0 AndAlso ds.Tables(0).Rows.Count > 0 Then
            ...
            If cantidad > 0 Then
                ' Ya existe la ficha, no se debe guardar
        ...
        Dim sql As String = "INSERT INTO controlinformesefluentes (id, fechacontrol, ficha, fecha, tipo, resultado, coincide, opcionmejora, noconformidad, observaciones, controlador, controlado) " &
    ...
    Public Function modificar(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        ...
        Dim sqlAccion As String = "INSERT INTO actividad (act_fecha, act_tabla, act_accion, act_registro, u_id) " _
                                 & "VALUES (now(), 'controlinformesefluentes', 'modificación', " & obj.ID & ", " & usuario.ID & ")"
        lista.Add(sqlAccion)
    ...
    Public Function eliminar(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        ...
        'Dim sql As String = "UPDATE controlinformesefluentes SET eliminado =1 WHERE id = " & obj.ID
        Dim lista As New ArrayList
        lista.Add(sql)

        Dim sqlAccion As String = "INSERT INTO actividad (act_fecha, act_tabla, act_accion, act_registro, u_id) " _
                                 & "VALUES (now(), 'controlinformesefluentes', 'eliminación', " & obj.ID & ", " & usuario.ID & ")"
        lista.Add(sqlAccion)
    ...
    Public Function listarxfecha(ByVal desde As String, ByVal hasta As String) As ArrayList
        Dim sql As String = _
            ...
            "FROM controlinformesefluentes m " & _
    ...
    Public Function marcarcontrolada(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        Dim obj As dControlInformesEfluentes = CType(o, dControlInformesEfluentes)
        Dim sql As String = "UPDATE controlinformesefluentes SET controlado=1, controlador = " & usuario.ID & " WHERE controlado=0 and ID = " & obj.ID & ""
    ...
    Public Function lstConNom(ByVal ficha As Long) As dControlBase
        Dim sql As String = "SELECT u.nombre AS controlador_nombre, " &
                            ...
                            "FROM dControlInformesEfluentes ci " &
