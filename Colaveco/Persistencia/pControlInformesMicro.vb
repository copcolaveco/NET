Public Class pControlInformesMicro
    ...
    Public Function guardar(ByVal o As Object) As Boolean
        ...
        Dim sqlVerificar As String = "SELECT COUNT(*) FROM controlinformesmicro WHERE ficha = " & obj.FICHA
        ...
        Dim sql As String = "INSERT INTO controlinformesmicro (id, fechacontrol, ficha, fecha, tipo, resultado, coincide, opcionmejora, noconformidad, observaciones, controlador, controlado) " &
    ...
    Public Function modificar(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        ...
        Dim sqlAccion As String = "INSERT INTO actividad (act_fecha, act_tabla, act_accion, act_registro, u_id) " _
                                 & "VALUES (now(), 'controlinformesmicro', 'modificación', " & obj.ID & ", " & usuario.ID & ")"
        lista.Add(sqlAccion)
    ...
    Public Function eliminar(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        ...
        Dim sqlAccion As String = "INSERT INTO actividad (act_fecha, act_tabla, act_accion, act_registro, u_id) " _
                                 & "VALUES (now(), 'controlinformesmicro', 'eliminación', " & obj.ID & ", " & usuario.ID & ")"
        lista.Add(sqlAccion)
    ...
    Public Function marcarcontrolada(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        Dim obj As dControlInformesMicro = CType(o, dControlInformesMicro)
        Dim sql As String = "UPDATE controlinformesmicro SET controlado=1, controlador = " & usuario.ID & " WHERE controlado=0 and ID = " & obj.ID & ""
