Public Class pSolicitudAnalisis
    ...
    Public Function guardar(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        ...
        Dim sql As String = "INSERT INTO solicitudanalisis (id, fechaingreso, idproductor, idtipoinforme, idsubinforme, idtipoficha, observaciones, nmuestras, idmuestra, idtecnico, sinsolicitud, sinconservante, temperatura, derramadas, desvio, idfactura, web, personal, email, fechaenvio, marca, eliminado, tambo, pago, importe, kmts, obsinternas, codigo, fechaproceso, muestreo, logo, interpretacion, fechamuestreo) VALUES (" & obj.ID & ", '" & obj.FECHAINGRESO & "'," & obj.IDPRODUCTOR & ", " & obj.IDTIPOINFORME & "," & obj.IDSUBINFORME & "," & obj.IDTIPOFICHA & ",'" & obj.OBSERVACIONES & "'," & obj.NMUESTRAS & ", " & obj.IDMUESTRA & ", " & obj.IDTECNICO & ", " & obj.SINCOLICITUD & ", " & obj.SINCONSERVANTE & "," & obj.TEMPERATURA & ", " & obj.DERRAMADAS & ", " & obj.DESVIOAUTORIZADO & ", " & obj.IDFACTURA & ", " & obj.WEB & ", " & obj.PERSONAL & ", " & obj.EMAIL & ", '" & obj.FECHAENVIO & "', " & obj.MARCA & ", " & obj.ELIMINADO & ", " & obj.TAMBO & ", " & obj.PAGO & ", " & obj.IMPORTE & ", " & obj.KMTS & ", '" & obj.OBSINTERNAS & "', '" & obj.CODIGO & "', '" & obj.FECHAPROCESO & "', " & obj.MUESTREO & ", " & obj.LOGO & ", '" & obj.INTERPRETACION & "', '" & obj.FECHAMUESTREO & "')"
    ...
    Public Function buscar(ByVal o As Object) As dSolicitudAnalisis
        ...
        Try
            ...
            Ds = Me.EjecutarSQL("SELECT id, fechaingreso, idproductor, idtipoinforme, idsubinforme, idtipoficha,observaciones, nmuestras, idmuestra, idtecnico, sinsolicitud, sinconservante, temperatura, derramadas, desvio, idfactura, web, personal, email, fechaenvio, marca, eliminado, tambo, pago, importe, kmts, ifnull(obsinternas,''), ifnull(codigo,''), fechaproceso, muestreo, logo, ifnull(interpretacion,''), fechamuestreo FROM solicitudanalisis WHERE id = " & obj.ID & "")
