...
Public Class FormValoresVacaIndividual
...
#End Region
    ...
    Private Sub ButtonBuscarProductor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonBuscarProductor.Click
        ...
        If Not v.Cliente Is Nothing Then
            ...
            TextNombreProductor.Text = cli.NOMBRE
        End If
    End Sub
    ...
    Private Sub listarxproductor()
        ...
        fechasta = Format(hasta, "yyyy-MM-dd")
        DataGridView1.Rows.Clear()
        listasa = sa.listarxfechaxproductor(fecdesde, fechasta, idproductor)
        Dim fila As Integer = 0
        Dim columna As Integer = 0
    ...
    Private Sub exceltodos()
        ...
        x1hoja.Cells(fila, columna).formula = "LISTADO DE VACA INDIVIDUAL - TODOS LOS PRODUCTORES - " & fecdesde & " - " & fechasta
