...
Namespace Conectoras
    Public Class ConexionMySQLGestor
        ...
        Private Shared mCadenaConexion As String = "Server=192.168.1.118;Database=colavecogx;Uid=root;Pwd=root;Convert Zero Datetime=True"
