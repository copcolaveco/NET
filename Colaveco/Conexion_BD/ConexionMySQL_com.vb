...
Namespace Conectoras
    Public Class ConexionMySQL_com
        ...
        Private Shared mCadenaConexion As String = "Server=colaveco.com.uy;Port=3306;DataBase=colaveco_colaveco;Uid=colaveco_colaveco;Pwd=cCVmhn[oQ_s;Convert Zero DateTime=true;"
