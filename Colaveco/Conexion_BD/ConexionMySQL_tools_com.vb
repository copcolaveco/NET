...
Namespace Conectoras
    Public Class ConexionMySQL_tools_com
        ...
        'Private Shared mCadenaConexion As String = "Server=colaveco.com.uy;Database=herramientas;Uid=colaveco;Pwd=Fmbh23052305;Convert Zero Datetime=True"
