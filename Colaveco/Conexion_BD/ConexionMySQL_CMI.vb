...
Namespace Conectoras
    Public Class ConexionMySQL_CMI
        ...
        Private Shared mCadenaConexion As String = "Server=192.168.1.20;Database=CMI;Uid=root;Pwd=root;Convert Zero Datetime=True"
        'Private Shared mCadenaConexion As String = "Server=192.168.1.20;Database=CMI;Uid=colaveco;Pwd=3w5go19bh6fdpsq7D5HJ;Convert Zero Datetime=True"
        'Private Shared mCadenaConexion As String = "Server=localhost;Database=CMI;Uid=root;Pwd=root;Convert Zero Datetime=True"
