...
Namespace Conectoras
    Public Class ConexionMySQL_uy
        ...
        Private Shared mCadenaConexion As String = "Server=colaveco.com.uy;Database=colav0_colaveco;Uid=colav0_colaveco;Pwd=colaveco5311;Convert Zero Datetime=True"
