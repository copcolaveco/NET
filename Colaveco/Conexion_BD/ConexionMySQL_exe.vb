...
Namespace Conectoras
    Public Class ConexionMySQL_exe
        ...
        Private Shared mCadenaConexion As String = "Server=192.168.1.20;Database=colaveco_exe;Uid=root;Pwd=root;Convert Zero Datetime=True"
