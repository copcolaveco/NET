Public Class pImpControl
    ...
    Public Function buscar(ByVal o As Object) As dImpControl
        ...
        Try
            ...
            Ds = Me.EjecutarSQL("SELECT id, ficha, fecha, equipo, producto, muestra, rc, grasa, proteina, lactosa, st, crioscopia, urea, proteinav, caseina, densidad, ph FROM control WHERE ficha = " & obj.ID)
    ...
    Public Function listar() As ArrayList
        Dim sql As String = "SELECT id, ficha, fecha, equipo, producto, muestra, rc, grasa, proteina, lactosa, st, crioscopia, urea, proteinav, caseina, densidad, ph FROM control order by id desc"
        Try
            Dim Lista As New ArrayList
            Dim Ds As New DataSet
