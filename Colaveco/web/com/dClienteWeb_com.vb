...
#Region "Métodos ABM"
    ...
    Public Function modificarnombre(ByVal usuario As dUsuario) As Boolean
        Dim p As New pClienteWeb_com
        Return p.modificarnombre(Me, usuario)
    End Function
    Public Function actualizaridnet(ByVal usuario As dUsuario) As Boolean
        Dim p As New pClienteWeb_com
        Return p.actualizaridnet(Me, usuario)
    End Function
    Public Function actualizarsaldo(ByVal usuario As dUsuario) As Boolean
        Dim p As New pClienteWeb_com
        Return p.actualizarsaldo(Me, usuario)
    End Function
    Public Function eliminar(ByVal usuario As dUsuario) As Boolean
        Dim p As New pClienteWeb_com
        Return p.eliminar(Me, usuario)
    End Function
    Public Function buscar() As dClienteWeb_com
        Dim p As New pClienteWeb_com
        Return p.buscar(Me)
    End Function
    Public Function buscarPorNombre(ByVal pnombre As String) As ArrayList
        Dim s As New pClienteWeb_com
