Public Class dControlAuxWeb_com
#Region "Atributos"
...
#Region "Métodos ABM"
    Public Function guardar() As Boolean
        Dim c As New pControlAuxWeb_com
        Return c.guardar(Me)
    End Function
    ...
    Public Function modificartambo(ByVal ficha As Long, ByVal tambo As Integer) As Boolean
        Dim c As New pControlAuxWeb_com
        Return c.modificartambo(ficha, tambo)
    End Function
    Public Function eliminar() As Boolean
        Dim c As New pControlAuxWeb_com
        Return c.eliminar(Me)
    End Function
    Public Function buscar() As dControlAuxWeb_com
        Dim c As New pControlAuxWeb_com
        Return c.buscar(Me)
    End Function
