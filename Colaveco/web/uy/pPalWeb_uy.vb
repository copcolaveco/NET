Public Class pPalWeb_uy
    Inherits Conectoras.ConexionMySQL_uy
    Public Function guardar(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        Dim obj As dPalWeb_uy = CType(o, dPalWeb_uy)
    ...
    Public Function eliminar(ByVal o As Object, ByVal usuario As dUsuario) As Boolean
        ...
        Return EjecutarTransaccion(lista)
    End Function
    Public Function buscar(ByVal o As Object) As dPalWeb_uy
        Dim obj As dPalWeb_uy = CType(o, dPalWeb_uy)
        Dim c As New dPalWeb_uy
        Try
            Dim Ds As New DataSet
            Ds = Me.EjecutarSQL("SELECT id, id_usuario, ifnull(id_productor,0), ifnull(comentario,''), abonado, fecha_creado, fecha_emision, ifnull(path_excel,''), ifnull(path_pdf,''), ifnull(path_csv,''), ficha, id_estado, ifnull(id_libro,0) FROM pal WHERE ficha = '" & obj.FICHA & "'")
