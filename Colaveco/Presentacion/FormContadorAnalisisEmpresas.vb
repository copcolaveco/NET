...
#End Region
    ...
    Private Sub ecolat()
        ...
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\ECOLAT\NET")
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\ECOLAT\NET\" & file.Name)
            ...
            If extension = "xls" Or extension = "XLS" Then
                Dim Arch As String
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\ECOLAT\NET\" & file.Name
    ...
    Private Sub calcar_carmelo()
        ...
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CALCAR CARMELO\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CALCAR CARMELO\NET\" & file.Name)
            Dim sLine As String = ""
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CALCAR CARMELO\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
    ...
    Private Sub calcar_tarariras()
        ...
        Dim timbres As Integer = 0
        'Dim folder As New DirectoryInfo("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche")
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CALCAR TARARIRAS\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            extension = Microsoft.VisualBasic.Right(file.Name, 3)
            'Dim objReader As New StreamReader("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name)
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CALCAR TARARIRAS\NET\" & file.Name)
            Dim sLine As String = ""
            'Dim arrText As New ArrayList()
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Dim Arch As String, CantFilas As Integer
                'Arch = "d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CALCAR TARARIRAS\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
    ...
    Private Sub caldem()
        ...
        Dim timbres As Integer = 0
        'Dim folder As New DirectoryInfo("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche")
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CALDEM\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            extension = Microsoft.VisualBasic.Right(file.Name, 3)
            'Dim objReader As New StreamReader("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name)
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CALDEM\NET\" & file.Name)
            Dim sLine As String = ""
            'Dim arrText As New ArrayList()
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Dim Arch As String, CantFilas As Integer
                'Arch = "d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CALDEM\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
    ...
    Private Sub dulei()
        ...
        Dim timbres As Integer = 0
        'Dim folder As New DirectoryInfo("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche")
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\DULEI\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            extension = Microsoft.VisualBasic.Right(file.Name, 3)
            'Dim objReader As New StreamReader("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name)
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\DULEI\NET\" & file.Name)
            Dim sLine As String = ""
            'Dim arrText As New ArrayList()
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Dim Arch As String, CantFilas As Integer
                'Arch = "d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\DULEI\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
    ...
    Private Sub brassetti()
        ...
        Dim timbres As Integer = 0
        'Dim folder As New DirectoryInfo("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche")
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\GRANJA BRASSETTI\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            extension = Microsoft.VisualBasic.Right(file.Name, 3)
            'Dim objReader As New StreamReader("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name)
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\GRANJA BRASSETTI\NET\" & file.Name)
            Dim sLine As String = ""
            'Dim arrText As New ArrayList()
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Dim Arch As String, CantFilas As Integer
                'Arch = "d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\GRANJA BRASSETTI\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
    ...
    Private Sub indulacsac()
        ...
        Dim timbres As Integer = 0
        'Dim folder As New DirectoryInfo("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche")
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CARDONA INDULACSA\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            extension = Microsoft.VisualBasic.Right(file.Name, 3)
            'Dim objReader As New StreamReader("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name)
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CARDONA INDULACSA\NET\" & file.Name)
            Dim sLine As String = ""
            'Dim arrText As New ArrayList()
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Dim Arch As String, CantFilas As Integer
                'Arch = "d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\CARDONA INDULACSA\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
    ...
    Private Sub indulacsas()
        ...
        Dim timbres As Integer = 0
        'Dim folder As New DirectoryInfo("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche")
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\SALTO INDULACSA\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            extension = Microsoft.VisualBasic.Right(file.Name, 3)
            'Dim objReader As New StreamReader("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name)
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\SALTO INDULACSA\NET\" & file.Name)
            Dim sLine As String = ""
            'Dim arrText As New ArrayList()
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Dim Arch As String, CantFilas As Integer
                'Arch = "d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\SALTO INDULACSA\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
    ...
    Private Sub magnolia()
        ...
        Dim timbres As Integer = 0
        'Dim folder As New DirectoryInfo("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche")
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\LA MAGNOLIA\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            extension = Microsoft.VisualBasic.Right(file.Name, 3)
            'Dim objReader As New StreamReader("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name)
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\LA MAGNOLIA\NET\" & file.Name)
            Dim sLine As String = ""
            'Dim arrText As New ArrayList()
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Dim Arch As String, CantFilas As Integer
                'Arch = "d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\LA MAGNOLIA\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
    ...
    Private Sub naturalia()
        ...
        Dim timbres As Integer = 0
        'Dim folder As New DirectoryInfo("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche")
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\NATURALIA\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            extension = Microsoft.VisualBasic.Right(file.Name, 3)
            'Dim objReader As New StreamReader("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name)
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\NATURALIA\NET\" & file.Name)
            Dim sLine As String = ""
            'Dim arrText As New ArrayList()
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Dim Arch As String, CantFilas As Integer
                'Arch = "d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\NATURALIA\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
    ...
    Private Sub pinerolo()
        ...
        Dim timbres As Integer = 0
        'Dim folder As New DirectoryInfo("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche")
        Dim folder As New DirectoryInfo("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\PINEROLO\NET")
        'Dim folder As New DirectoryInfo("\\srvcolaveco\d\documentos\secretaria\resultados informes 2012")
        Dim fila As Integer = 0
        Dim columna As Integer = 0
        DataGridView1.Rows.Add(100)
        ...
        For Each file As FileInfo In folder.GetFiles("*.xls")
            ...
            extension = Microsoft.VisualBasic.Right(file.Name, 3)
            'Dim objReader As New StreamReader("d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name)
            Dim objReader As New StreamReader("\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\PINEROLO\NET\" & file.Name)
            Dim sLine As String = ""
            'Dim arrText As New ArrayList()
            ...
            If extension = "xls" Or extension = "XLS" Then
                ...
                Dim Arch As String, CantFilas As Integer
                'Arch = "d:\documentos\secretaria\analisis\leche\bentley-delta\pasados\calidad de leche\" & file.Name
                Arch = "\\Srvcolaveco\D\Documentos\SECRETARIA\RESULTADOS INFORMES 2013\LECHE\CALIDAD\PINEROLO\NET\" & file.Name
                Dim x1app As Microsoft.Office.Interop.Excel.Application
                Dim x1libro As Microsoft.Office.Interop.Excel.Workbook
                Dim x1hoja As Microsoft.Office.Interop.Excel.Worksheet
