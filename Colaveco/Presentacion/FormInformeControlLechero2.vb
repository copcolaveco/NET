...
Imports System.IO
Public Class FormInformeControlLechero2
...
#End Region
    ...
    Private Sub creainformeexcel()
        ...
        Dim Arch As String
        'Arch = "\\Srvcolaveco2\datos (d)\NET\PRE INFORMES\CONTROL\" & idsol & ".xls"
        Arch = "\\ROBOT\PRE INFORMES\CONTROL\" & idsol & ".xls"
    ...
    Private Sub creainformetxt()
        ...
        'Dim oSW As New StreamWriter("\\Srvcolaveco2\datos (d)\NET\PRE INFORMES\CONTROL\" & idficha & ".txt")
        Dim oSW As New StreamWriter("\\ROBOT\PRE INFORMES\CONTROL\" & idficha & ".txt")
        Dim c As New dControl
