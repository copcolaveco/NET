...
#End Region
    ...
    Private Sub CheckMoroso_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckMoroso.CheckedChanged
        If CheckMoroso.Checked = True Then
            Dim p As New dProductor
            Dim codfigaro As String = TextFigaro.Text.Trim
            If codfigaro <> "" Then
        ...
        Else
            ...
            Dim codfigaro As String = TextFigaro.Text.Trim
            If codfigaro <> "" Then
                p.desmarcarmoroso(codfigaro, Usuario)
            End If
        End If
    End Sub
End Class