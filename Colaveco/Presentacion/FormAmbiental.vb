...
#End Region
    ...
    Private Sub ListFichas_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListFichas.SelectedIndexChanged
        ...
        If ListFichas.SelectedItems.Count = 1 Then
            ...
            Dim id As Long = a2.IDSOLICITUD
            Dim lista As New ArrayList
            lista = a2.listarporid(id)
            a.IDSOLICITUD = a2.IDSOLICITUD
            a = a.buscar
    ...
    Private Sub creainformeexcel()
        ...
        If Not lista Is Nothing Then
            If lista.Count > 0 Then
                ...
                If a2.LISTMONO = 1 Then
                    texto2 = texto2 + "Listeria monocitógenes - "
                End If
                If a2.SALMONELLA = 1 Then
                    texto2 = texto2 + "Salmonella - "
                End If
                If a2.ECOLI = 1 Then
                ...
                End If
                If a2.MOHOSYLEVADURAS = 1 Then
                    texto3 = texto3 & "Mohos y levaduras - Placa / "
                End If
                If a2.CT = 1 Then
                ...
                For Each a In lista
                    ...
                    If i = 1 Then
                        ...
                        If a.SALMONELLA <> -1 Then
                            fila = fila + 1
                            x1hoja.Cells(fila, columna).Formula = "Salmonella"
                            x1hoja.Cells(fila, columna).HorizontalAlignment = XlHAlign.xlHAlignLeft
                            x1hoja.Cells(fila, columna).BORDERS.color = RGB(0, 0, 0)
                            x1hoja.Cells(fila, columna).Font.Bold = True
                            x1hoja.Cells(fila, columna).Font.Size = 10
                ...
                ana.ID = idlistambiental
                ana = ana.buscar
                preciolistambiental = ana.COSTO
                ana.ID = idct
                ana = ana.buscar
                precioct = ana.COSTO
                ana.ID = idcf
                ana = ana.buscar
                preciocf = ana.COSTO
                ana.ID = idpseudomonaspp
                ana = ana.buscar
                preciopseudomonaspp = ana.COSTO
                ana.ID = idmesofilos
                ana = ana.buscar
                preciomesofilos = ana.COSTO
                ana.ID = identerobacterias
                ana = ana.buscar
                precioenterobacterias = ana.COSTO
                ana.ID = idmohosylevaduras
                ana = ana.buscar
                preciomohosylevaduras = ana.COSTO
                ana.ID = idtimbre
                ana = ana.buscar
        ...
        x1hoja.SaveAs("\\SRVCOLAVECO\D\NET\AMBIENTAL\" & idsol & ".xls")
        'x1hoja.SaveAs("c:\NET\SUBPRODUCTO\" & idsol & ".xls")
