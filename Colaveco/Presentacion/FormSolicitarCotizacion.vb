...
#End Region
    ...
    Private Sub ButtonGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonGuardar.Click
        ...
        '**********************************************************************
        Dim Arch1 As String
        Arch1 = "\\SRVCOLAVECO\D\NET\COMPRAS\SOLICITUDES\SC_" & cotizacionid & ".xls"
    ...
    Private Sub enviaremail()
        ...
        If email <> "" Then
            ...
            Dim _File As String = "\\SRVCOLAVECO\D\NET\COMPRAS\SOLICITUDES\SC_" & cotizacionid & ".xls" 'archivo que se quiere adjuntar ‘
        ...
        If email2 <> "" Then
            ...
            'Codificacion 
            '_Message.Body = "Se han enviado las siguientes cajas:" & " " & ecaja1 & ", " & "por" & " " & eagencia & " " & "envío nº" & " " & eremito & ""
            _Message.Body = "Sres. de" & " " & destinatario2 & ", " & "por medio del presente correo adjuntamos solicitud de cotización. Desde ya gracias. COLAVECO"
            'contenido del mail 
            _Message.BodyEncoding = System.Text.Encoding.UTF8 '
            _Message.Priority = System.Net.Mail.MailPriority.Normal
            _Message.IsBodyHtml = False
        ...
        If email3 <> "" Then
            ...
            'Codificacion 
            '_Message.Body = "Se han enviado las siguientes cajas:" & " " & ecaja1 & ", " & "por" & " " & eagencia & " " & "envío nº" & " " & eremito & ""
            _Message.Body = "Sres. de" & " " & destinatario3 & ", " & "por medio del presente correo adjuntamos solicitud de cotización. Desde ya gracias. COLAVECO"
            'contenido del mail 
            _Message.BodyEncoding = System.Text.Encoding.UTF8 '
            _Message.Priority = System.Net.Mail.MailPriority.Normal
            _Message.IsBodyHtml = False
    ...
    Private Sub generarsolicitud()
        ...
        x1hoja.SaveAs("\\SRVCOLAVECO\D\NET\COMPRAS\SOLICITUDES\SC_" & idcotizacion & ".xls")
