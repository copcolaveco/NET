Public Class pAutorizaciones
    ...
    Public Function listarPorFiltros(ByVal desde As String, ByVal hasta As String, ByVal id As Integer) As ArrayList
        ...
        Dim sql As String = "SELECT id, fecha, idusuario, tipo, fechaevento, detalle, autoriza, observaciones, autorizada, email FROM autorizaciones WHERE fechaevento BETWEEN '" & desde & "' and '" & hasta & "' and " + idQuery + " ORDER BY fechaevento desc"
        Try
            Dim Lista As New ArrayList
            Dim Ds As New DataSet
            Ds = Me.EjecutarSQL(sql)
